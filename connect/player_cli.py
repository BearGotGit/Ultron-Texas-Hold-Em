...
class PlayerClient:
    ...
    # TODO: CHANGE FUNCTION DEFINITION TO PASS ANY KIND OF POKERPLAYER AGENT (an abstract class)
    def run_input_loop(self, agent: PokerPlayer):
        # simple input loop; you can type even if it's not your turn, we gate it
        while True:

            # TODO: REMOVE MANUAL HUMAN INPUT
            cmd = ""
            ...
            # TODO: LET AGENT MAKE CHOICE / REPLACE THIS CODE
            # TODO: FIND WAY TO GET DATA SO WE CAN MAKE INTELLIGENT DECISIONS
...
def main():
    ...
    # TODO: AGENT INITIALIZED
    agent = RandomAgent("Baby Ultron")

    # TODO: PASS AGENT TO INPUT LOOP 
    client.run_input_loop(agent)
